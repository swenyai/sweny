...
import { datadog, sentry, cloudwatch, splunk, elastic, newrelic, loki, file, prometheus, pagerduty, vercel, supabase, netlify, fly, render, heroku, opsgenie, honeycomb, axiom, betterstack, } from "@sweny-ai/providers/observability";
...
export function createProviders(config) {
    ...
    switch (config.sourceControlProvider) {
        ...
        case "gitlab":
            ...
            break;
        case "file":
            registry.set("sourceControl", fileSourceControl({ outputDir: config.outputDir, baseBranch: config.baseBranch, logger: actionsLogger }));
            break;
        default:
