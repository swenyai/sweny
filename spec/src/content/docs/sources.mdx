...
- `workflow.rules[]` — [Workflow](/workflow)
- `workflow.context[]` — [Workflow](/workflow)
- `node.rules[]` / `node.context[]` — [Nodes](/nodes) (per-node knowledge)
- `workflow.input.rules[]` — [Workflow — Runtime Input](/workflow#runtime-input)
- `workflow.input.context[]` — [Workflow — Runtime Input](/workflow#runtime-input)
