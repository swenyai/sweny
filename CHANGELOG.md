...
- Added `exports` field to `@sweny/agent` package.json
...
- **@sweny/providers** — shared provider interfaces and implementations
...
- **@sweny/agent** — AI assistant framework with Slack bot + CLI
- **@sweny/web** — Astro-based documentation site
