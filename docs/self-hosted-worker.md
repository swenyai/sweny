...
that sweny.ai cloud uses, but inside your own infrastructure — pointing at the
sweny.ai orchestration API for job dispatch and result storage.

This is the **BYO Worker** tier: sweny.ai handles orchestration, scheduling, the
