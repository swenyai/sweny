import type { IssueTrackingProvider, TriageHistoryCapable } from "@sweny/providers/issue-tracking";
...
export async function buildContext(ctx: WorkflowContext<TriageConfig>): Promise<StepResult> {
