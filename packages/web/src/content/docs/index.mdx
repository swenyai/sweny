...
<CardGrid>
  ...
  <Card title="Security Reviews" icon="seti:lock">
    Ingest vendor questionnaires, draft answers from your security posture docs, and validate nothing is overstated.
  </Card>
  <Card title="All Use Cases" icon="right-arrow">
    Competitive monitoring, contract management, feedback synthesis, and more. [Browse use cases](/use-cases/)
  </Card>
</CardGrid>
