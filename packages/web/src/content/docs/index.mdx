...
hero:
  ...
  actions:
    ...
    - text: Browse Marketplace
      link: https://marketplace.sweny.ai
      icon: external
      variant: secondary
    - text: View on GitHub
...
Install the [Claude Code plugin](/advanced/mcp-plugin/) and get slash commands, MCP tools, and a startup hook — without leaving your conversation:
...
**[marketplace.sweny.ai](https://marketplace.sweny.ai)** — a community catalog of ready-to-run SWEny workflows. Browse by category, copy a workflow into `.sweny/workflows/`, customize the steps, and run it. The CLI and Action are free and always will be.
